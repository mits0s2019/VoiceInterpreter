...
public class AmbiguitieService {
    ...
    private  Set<String> ambiguities = new TreeSet<>();

    public AmbiguitieService() {
    }
     ...
     */
    public  void search(String inputNumber) throws ExceptionHandler {
     ...
     */
    public  void recursionList(List<Integer> list, int index) throws ExceptionHandler {

        getAmbiguities().add(ArrayUtils.listIntegerToString(list));  //adding the converted String list to ambiguities list
     ...
     */
    private  void createAmbiguitieList(Integer[][] array,List<Integer>list, int index) throws ExceptionHandler {
